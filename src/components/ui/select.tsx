  ...
  return (
    <label className="block w-full" htmlFor={selectId}>
      ...
      <select
        id={selectId}
        className={cn(
          "h-11 w-full appearance-none rounded-lg border border-border bg-surface bg-[length:16px] bg-[right_12px_center] bg-no-repeat px-3 pr-10 text-sm text-foreground shadow-sm outline-none transition-shadow focus:border-primary focus:ring-2 focus:ring-ring/20",
          className,
        )}
        style={{
          backgroundImage:
